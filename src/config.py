...
class Config:
    def __init__(self):
        """
        Config class for handling game configuration settings.
        """
        # List to store different themes
        self.themes = []
        
        # Load predefined themes
        self._add_themes()
        
        # Index to track the current theme
        self.idx = 0
    ...
    def change_theme(self):
        """
        Change the current theme to the next one in the list.
        """
        self.idx += 1
    ...
    def _add_themes(self):
        """
        Create and add predefined themes to the themes list.
        """
